...
from cart.views import CartDetailView, CartAddView, CartRemoveView,  CartUpdateView, CartClearView, DiscountView
...
urlpatterns = [
    ...
    path('cart_discount/', DiscountView.as_view(), name='cart_discount'),
]